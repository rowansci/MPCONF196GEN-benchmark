...
Reference conformers were generated with CREST iMTD-GC [2] using GFN2-xTB [3] and conformer energies were computed using Egret-1 [4] neural network potential.
